...
2. Заполни [brand.md](brand.md) — голос бренда, тон, стоп-фразы
...
Без заполненного brand.md агенты будут угадывать твой голос.
...
├── brand.md                   ← голос бренда (ЗАПОЛНИТЬ)
